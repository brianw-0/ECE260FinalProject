...
def generate_data(data, samples, targeted=True, start=0, inception=False):
    ...
    for i in range(samples):
        if targeted:
            ...
            # Filename scheme is label.somenumber.jpg
            #filename = ".images/" + data.test_labels[start+i] + "." + str(i) + ".jpg"
            #imageio.imwrite(filename, data.test_data[start+i])
